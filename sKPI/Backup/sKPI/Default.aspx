...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
   ...
   <table>
   <tr>
   <td><asp:Label ID="Label1" runat="server" Text="Data Inicial"></asp:Label> 
   </td>
      <td><asp:Label ID="Label3" runat="server" Text= "         "></asp:Label> 
   </td>
   <td class="style1"><asp:Label ID="Label2" runat="server" Text="Data Final"></asp:Label> 
   </td>
   <td>
   </td>
   </tr>
   ...
   <td><asp:TextBox ID="TxtDataini" runat="server"></asp:TextBox> </td>
    ...
    <td><asp:Button ID="BtnSalvar" runat="server" Text="Salvar" Visible="False" /> </td>
   </tr>
   </table>
   <p>
